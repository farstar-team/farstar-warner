...
- پاسخ‌های ورود اجباری، چالش امنیتی، خطاهای شبکه و خطاهای موقت به‌عنوان وضعیت نامشخص در نظر گرفته می‌شوند و وضعیت ذخیره‌شده را تغییر نمی‌دهند. Playwright فقط 404 صریح یا متن استاندارد نبودن صفحه را شاهد غیرفعال می‌داند.
...
- هر چرخه و تست پنج‌دقیقه‌ای baseline سه‌گانه، مسیر اتصال و توانایی ساخت کارت تصویری را بررسی می‌کند؛ خطای تشخیصی برای مدیر و بازیابی سلامت اطلاع‌رسانی می‌شود.
