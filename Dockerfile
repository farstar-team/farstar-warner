...
RUN apt-get update \
    && apt-get install -y --no-install-recommends ca-certificates chromium curl fontconfig fonts-dejavu-core fonts-noto-core fonts-noto-extra fonts-noto-ui-core fonts-noto-color-emoji \
